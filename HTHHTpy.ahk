...
{
jsCode := variables . onKeyPress . "`n`n" . HotKeyCalledHotKyes . "`n`n" . jsCode
}
else
{
jsCode := variables . "`n`n" . funcs . "`n`n" . onKeyPress . "`n`n" . HotKeyCalledHotKyes . "`n`n" . jsCode
}
